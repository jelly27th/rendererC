...
set(HEADER_FILES ${HEADER_FILES} source/maths/point/point.h)
...
set(HEADER_FILES ${HEADER_FILES} source/renderer/framebuffer/framebuffer.h)
set(HEADER_FILES ${HEADER_FILES} source/renderer/graphics/graphics.h)
set(HEADER_FILES ${HEADER_FILES} source/renderer/mesh/mesh.h)
set(HEADER_FILES ${HEADER_FILES} source/renderer/renderer.h)
...
set(SOURCE_FILES ${SOURCE_FILES} source/maths/point/point.c)
...
set(SOURCE_FILES ${SOURCE_FILES} source/renderer/framebuffer/framebuffer.c)
set(SOURCE_FILES ${SOURCE_FILES} source/renderer/graphics/graphics.c)
